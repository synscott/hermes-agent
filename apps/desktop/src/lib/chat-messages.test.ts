...
describe('mergeFinalAssistantText', () => {
  it('removes all text parts and appends the final text', () => {
    ...
    const result = mergeFinalAssistantText(parts, 'final answer', true)
  ...
  it('drops reasoning that the final text fully covers (reasoning ⊆ final)', () => {
    ...
    const result = mergeFinalAssistantText(parts, 'Let me check the files. Everything looks good.', true)
  ...
  it('keeps a longer reasoning block when the final text is only a short prefix', () => {
    ...
    const result = mergeFinalAssistantText(parts, 'Done.', true)
  ...
  it('keeps non-restating reasoning', () => {
    ...
    const result = mergeFinalAssistantText(parts, 'Fixed the race condition.', true)
  ...
  it('handles empty final text', () => {
    ...
    const result = mergeFinalAssistantText(parts, '', true)
